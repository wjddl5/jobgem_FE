                        ...
                        {ar.map((user) => (
                            ...
                            >
                                <TableCell align="center" sx={{ fontFamily: 'pl,sans-serif', whiteSpace: 'normal', wordBreak: 'break-all' }}>
                                    {user.joImgUrl == null ? <img src='/img/profile_default.png' style={{ width: '50px', height: '50px', display: 'block', margin: 'auto', borderRadius: '50%'}}/> : <img src={`/s3/${user.joImgUrl}`} alt="회원사진" style={{ width: '50px', height: '50px', display: 'block', margin: 'auto', borderRadius: '50%' }} />}
                                </TableCell>
