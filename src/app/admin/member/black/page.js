					...
					<TableBody>
						{ar.map((user, idx) => (
							<TableRow key={idx} hover sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
								...
								<TableCell align='center' sx={{ whiteSpace: 'normal', wordBreak: 'break-all', fontFamily: 'pl,sans-serif' }}>{user.joImgUrl == null ? <img src='/img/profile_default.png' style={{ width: '50px', height: '50px', display: 'block', margin: 'auto', borderRadius: '50%'}}/> : <img src={`/s3/${user.joImgUrl}`} alt="회원사진" style={{ width: '50px', height: '50px', display: 'block', margin: 'auto', borderRadius: '50%' }} />}</TableCell>
