...
export default function page() {
  ...
  const ar = [
    { bo_idx: 0, bo_title: "문의1", writer: "홍길동", bo_writedate: "2024-08-24", bo_hit: 10, bo_like: 5, c_list: [1, 2, 3] },
    { bo_idx: 1, bo_title: "문의2", writer: "홍길동2", bo_writedate: "2024-08-24", bo_hit: 11, bo_like: 55, c_list: [1, 2, 3] },
    { bo_idx: 2, bo_title: "문의3", writer: "홍길동3", bo_writedate: "2024-08-24", bo_hit: 12, bo_like: 53, c_list: [1, 2, 3] },
    { bo_idx: 3, bo_title: "문의4", writer: "홍길동4", bo_writedate: "2024-08-24", bo_hit: 105, bo_like: 51, c_list: [1, 2, 3] },
    { bo_idx: 4, bo_title: "문의5", writer: "홍길동5", bo_writedate: "2024-08-24", bo_hit: 106, bo_like: 15, c_list: [1, 2, 3] },
  ];
  ...
  return (
    <div>
      <div className="bbs_header">
        ...
        <div className="bbs_toolBox">
          ...
          <div className="bbs_btn">
            <Button variant="contained" onClick={() => router.push(`/bbs/qna/write/${1}`)}>
              글쓰기
            </Button>
      ...
      <Table>
        ...
        <TableBody>
          {ar.map((row) => (
            <TableRow key={row.bo_idx} className={styles.tableRow} onClick={() => router.push(`/bbs/qna/view/${row.bo_idx}`)} hover>
              <TableCell>
              ...
              <TableCell>{row.bo_title} | 답변상태</TableCell>
